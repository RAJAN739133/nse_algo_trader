...
# Additional high-liquidity F&O stocks for more trading opportunities
FNO_LIQUID_EXTRA = ["TATAMOTORS","IDEA","AARTIIND","ABFRL","AMARAJABAT","APLLTD","BAJAJHLDNG","BALRAMCHIN","BLUESTARCO","BSOFT","CUB","CYIENT","DALBHARAT","DELTACORP","DEVYANI","EMAMILTD","GNFC","GODREJPROP","GSFC","GUJGASLTD","HATSUN","HINDZINC","HONASA","HUDCO","ICICIPRULI","IDFC","IEX","IIFL","INDIANB","INTELLECT","IREDA","J&KBANK","JKCEMENT","JSWENERGY","KALYANKJIL","KEC","KIOCL","LATENTVIEW","LICI","LINDEINDIA","LLOYDSME","LTF","MAHABANK","MCX","METROPOLIS","MSUMI","NBCC","NCC","NSLNISP","OLECTRA","PATANJALI","PNBHOUSING","POLICYBZR","PVRINOX","RADICO","RAJESHEXPO","RAMCOCEM","RVNL","SBICARD","SCHAEFFLER","SHRIRAMFIN","SONACOMS","SUPREMEIND","TANLA","TATACHEM","TATAINVEST","TATATECH","THERMAX","TORNTPOWER","TTML","TV18BRDCST","UNITDSPR","UCOBANK","ZEEL","ZOMATO"]
...
def get_universe(name=None):
    ...
    if "fno" in name or "all" in name: return NIFTY_50 + NIFTY_100_EXTRA + NIFTY_250_EXTRA + FNO_LIQUID_EXTRA
    elif "250" in name: return NIFTY_50 + NIFTY_100_EXTRA + NIFTY_250_EXTRA
    elif "100" in name: return NIFTY_50 + NIFTY_100_EXTRA
    return NIFTY_50
DEFAULT_UNIVERSE = get_universe()
ALL_STOCKS = NIFTY_50 + NIFTY_100_EXTRA + NIFTY_250_EXTRA + FNO_LIQUID_EXTRA
...
STOCK_SECTORS = {
    ...
    # FNO Liquid Extra stocks
    "TATAMOTORS": "Auto", "IDEA": "Telecom", "AARTIIND": "Chemicals", "ABFRL": "Retail",
    "AMARAJABAT": "Auto", "APLLTD": "Pharma", "BAJAJHLDNG": "Finance", "BALRAMCHIN": "FMCG",
    "BLUESTARCO": "Consumer", "BSOFT": "IT", "CUB": "Banking", "CYIENT": "IT",
    "DALBHARAT": "Cement", "DELTACORP": "Consumer", "DEVYANI": "Consumer", "EMAMILTD": "FMCG",
    "GNFC": "Chemicals", "GODREJPROP": "Realty", "GSFC": "Chemicals", "GUJGASLTD": "Energy",
    "HATSUN": "FMCG", "HINDZINC": "Metals", "HONASA": "FMCG", "HUDCO": "Finance",
    "ICICIPRULI": "Insurance", "IDFC": "Finance", "IEX": "Exchange", "IIFL": "Finance",
    "INDIANB": "Banking", "INTELLECT": "IT", "IREDA": "Finance", "J&KBANK": "Banking",
    "JKCEMENT": "Cement", "JSWENERGY": "Power", "KALYANKJIL": "Retail", "KEC": "Infra",
    "KIOCL": "Metals", "LATENTVIEW": "IT", "LICI": "Insurance", "LINDEINDIA": "Chemicals",
    "LLOYDSME": "Metals", "LTF": "Finance", "MAHABANK": "Banking", "MCX": "Exchange",
    "METROPOLIS": "Healthcare", "MSUMI": "Auto", "NBCC": "Infra", "NCC": "Infra",
    "NSLNISP": "Metals", "OLECTRA": "Auto", "PATANJALI": "FMCG", "PNBHOUSING": "Finance",
    "POLICYBZR": "Insurance", "PVRINOX": "Media", "RADICO": "FMCG", "RAJESHEXPO": "FMCG",
    "RAMCOCEM": "Cement", "RVNL": "Infra", "SBICARD": "Finance", "SCHAEFFLER": "Auto",
    "SHRIRAMFIN": "Finance", "SONACOMS": "Auto", "SUPREMEIND": "Chemicals", "TANLA": "IT",
    "TATACHEM": "Chemicals", "TATAINVEST": "Finance", "TATATECH": "IT", "THERMAX": "Engineering",
    "TORNTPOWER": "Power", "TTML": "Telecom", "TV18BRDCST": "Media", "UNITDSPR": "Consumer",
    "UCOBANK": "Banking", "ZEEL": "Media", "ZOMATO": "Tech",
}
